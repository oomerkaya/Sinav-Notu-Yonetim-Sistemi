...
void main()
{
	int notlar[10], i, A = 0, B = 0, C = 0, D =0, F = 0, en_kucuk = 101, en_buyuk = -1, fark = 0, Toplam = 0, tek_indis_toplam = 0, cift_indis_toplam = 0;
	float N_O = 0, cift_indis_ortalama = 0, tek_indis_ortalama = 0;
	printf("Girilen not degerleri 0-100 arasinda olmalidir.\n\n");
	...
	N_O = (float)Toplam / 10;
	cift_indis_ortalama = (float) cift_indis_toplam / 10;
	tek_indis_ortalama = (float) tek_indis_toplam / 10;
